		...
		<div class="form-wrapper">
			...
			<form>
				...
				<div class="form-group d-flex justify-content-between">
					...
					<a data-where='reset-credentials' href="#">Reset password</a>
				</div>
				...
				<a data-where='sign-up' href="" class="btn btn-outline-light btn-sm">Register now!</a>
			</form>
			<!-- ./ form -->
		</div>`;
	},
