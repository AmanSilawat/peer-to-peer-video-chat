...
let ResetCredentials = {
	before_render: async () => {
		utils.handle_css(['common', 'ResetCredentials']);
	},
	...
	render: async () => {
		...
		<div class="form-wrapper">
			...
			<form>
				...
				<a data-where='sign-up' href="#" class="btn btn-sm btn-outline-light mr-1">Register now!</a>
				or
				<a data-where='login' href="#" class="btn btn-sm btn-outline-light ml-1">Login!</a>
			</form>
			<!-- ./ form -->
		</div>
		`;
