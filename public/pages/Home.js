...
let Home = {
    before_render: async () => {
        utils.handle_css(['common', 'bundle', 'enjoyhint', 'app.min']);
    },
					...
					<div class="modal-body text-center pt-5">
						<div class="row">
							<div class="col-md-6 offset-3">
								<figure>
									<img src="./visuals/undraw_product_tour_foyt.svg" class="img-fluid" alt="image">
								</figure>
			...
			<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom" role="document">
				<div class="modal-content">
					<div class="modal-body">
						<div class="row mb-5">
							<div class="col-md-6 offset-3">
								<img src="./visuals/undraw_warning_cyit.svg" class="img-fluid" alt="image">
							</div>
						</div>
						...
						<div class="no-message-container">
							<div class="row mb-5">
								<div class="col-md-4 offset-4">
									<img src="./visuals/undraw_empty_xct9.svg" class="img-fluid" alt="image">
								</div>
							</div>
    ...
    after_render: async () => {
		...
		utils.handle_js(['bundle', 'enjoyhint.min', 'app.min', 'examples']);
    },
};
